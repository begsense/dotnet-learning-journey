...
internal class AuthService : IAuthService
{
    ...
    public bool SignUp(string email, string userName, string password)
    {
        ...
        visual.WriteColored("Sending code... wait please", ConsoleColor.Cyan);
        ...
        visual.WriteColored("Verification code sent, please check email", ConsoleColor.Magenta);

        visual.WriteColored("Enter verification code: ", ConsoleColor.White, line: false);
